// Step 1: Remove the `.example` from this file name so it is called `configs.ts` or copy the contents of the `configs.ts` file into a new `configs.ts` file
...
export const configs = {
  ...
  token: "NjQzNDQwMzU5NDM0ODc4OTc3.XclgiA.QUQBiTESwOwwpmAmwKaU21ynyM8",
  ...
  userIds: {
    ...
    botDevs: ["633668381954015235"] as string[],
    // The user ids who have complete 100% access to your bot
    botOwners: ["633668381954015235",]
  },
  webhooks: {
